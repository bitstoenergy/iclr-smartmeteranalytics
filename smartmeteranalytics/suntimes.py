...
if __name__ == "__main__":
    import pytz
    # Queries have to be made with a timezone aware datetime and will be
    # returned as non timezone aware time objects in the local timezone
    s = Sun(lat=52.37, long=4.90)  # Amsterdam
    print(s.sunrise(datetime.now(tz=pytz.timezone("Europe/Amsterdam"))))
    print(s.sunset(when=datetime.now(tz=pytz.timezone("Europe/Amsterdam"))))
